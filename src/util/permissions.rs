...
pub fn get_permission(conf: &Config, check_permission: &str) -> Result<i64, Box<dyn Error + Send + Sync>> {
...
pub fn check_permission(conf: &Config, roles: Option<&Vec<Id<RoleMarker>>>, user_id: &String, check_permissions: Vec<&str>) -> bool {
